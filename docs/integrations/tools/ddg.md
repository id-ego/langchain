...
description: 이 가이드는 DuckDuckGo 검색 구성 요소 사용 방법을 설명하며, 검색 결과를 효과적으로 활용하는 방법을 안내합니다.
---

# DuckDuckGo 검색

이 가이드는 DuckDuckGo 검색 구성 요소를 사용하는 방법을 보여줍니다.
...
```python
<!--IMPORTS:[{"imported": "DuckDuckGoSearchRun", "source": "langchain_community.tools", "docs": "https://api.python.langchain.com/en/latest/tools/langchain_community.tools.ddg_search.tool.DuckDuckGoSearchRun.html", "title": "DuckDuckGo Search"}]-->
...
추가 정보를 얻으려면 (예: 링크, 출처) `DuckDuckGoSearchResults()`를 사용하세요.

```python
<!--IMPORTS:[{"imported": "DuckDuckGoSearchResults", "source": "langchain_community.tools", "docs": "https://api.python.langchain.com/en/latest/tools/langchain_community.tools.ddg_search.tool.DuckDuckGoSearchResults.html", "title": "DuckDuckGo Search"}]-->
...
뉴스 기사를 검색할 수도 있습니다. 키워드 `backend="news"`를 사용하세요.
...
사용자 정의 `DuckDuckGoSearchAPIWrapper`를 `DuckDuckGoSearchResults`에 직접 전달하여 검색 결과에 대한 더 많은 제어를 제공할 수도 있습니다.

```python
<!--IMPORTS:[{"imported": "DuckDuckGoSearchAPIWrapper", "source": "langchain_community.utilities", "docs": "https://api.python.langchain.com/en/latest/utilities/langchain_community.utilities.duckduckgo_search.DuckDuckGoSearchAPIWrapper.html", "title": "DuckDuckGo Search"}]-->
...
- [도구 호출을 위한 채팅 모델 사용 방법](https://python.langchain.com/v0.2/docs/how_to/tool_calling/)
