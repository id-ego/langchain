...
description: 이 문서는 PubMed를 도구로 사용하는 방법을 설명하며, 3500만 개 이상의 생물 의학 문헌 인용을 포함합니다.
---

# PubMed

> [PubMed®](https://pubmed.ncbi.nlm.nih.gov/)는 `MEDLINE`, 생명 과학 저널 및 온라인 서적에서 3,500만 개 이상의 생물 의학 문헌 인용을 포함합니다. 인용에는 PubMed Central 및 출판사 웹사이트의 전체 텍스트 콘텐츠에 대한 링크가 포함될 수 있습니다.

이 노트북은 `PubMed`를 도구로 사용하는 방법에 대해 설명합니다.
