---
custom_edit_url: https://github.com/langchain-ai/langchain/edit/master/docs/docs/integrations/tools/google_scholar.ipynb
description: 이 노트북은 Google Scholar 도구 사용법을 안내하며, 관련 코드와 자료를 제공합니다.
---

# 구글 스칼라

이 노트북은 구글 스칼라 도구를 사용하는 방법을 설명합니다.
...
```python
<!--IMPORTS:[{"imported": "GoogleScholarQueryRun", "source": "langchain_community.tools.google_scholar", "docs": "https://api.python.langchain.com/en/latest/tools/langchain_community.tools.google_scholar.tool.GoogleScholarQueryRun.html", "title": "Google Scholar"}, {"imported": "GoogleScholarAPIWrapper", "source": "langchain_community.utilities.google_scholar", "docs": "https://api.python.langchain.com/en/latest/utilities/langchain_community.utilities.google_scholar.GoogleScholarAPIWrapper.html", "title": "Google Scholar"}]-->
import os
