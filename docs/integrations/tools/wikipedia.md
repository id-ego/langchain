...
description: 위키백과는 자원봉사자들이 작성하고 유지하는 다국어 무료 온라인 백과사전으로, MediaWiki 시스템을 통해 협업하여 운영됩니다.
---

# 위키백과

> [위키백과](https://wikipedia.org/)는 위키백과인 자원봉사자 커뮤니티에 의해 작성되고 유지되는 다국어 무료 온라인 백과사전으로, 개방형 협업과 MediaWiki라는 위키 기반 편집 시스템을 사용합니다. `위키백과`는 역사상 가장 크고 가장 많이 읽힌 참고 자료입니다.
...
```python
<!--IMPORTS:[{"imported": "WikipediaQueryRun", "source": "langchain_community.tools", "docs": "https://api.python.langchain.com/en/latest/tools/langchain_community.tools.wikipedia.tool.WikipediaQueryRun.html", "title": "Wikipedia"}, {"imported": "WikipediaAPIWrapper", "source": "langchain_community.utilities", "docs": "https://api.python.langchain.com/en/latest/utilities/langchain_community.utilities.wikipedia.WikipediaAPIWrapper.html", "title": "Wikipedia"}]-->
